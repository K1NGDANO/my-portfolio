    ...
    return (
        <main className="bg-black-200 min-h-screen p-12">
            <article className="container shadow-lg mx-auto bg-purple-100 rounded-lg">
                <header className="relative">
                    <div className="absolute h-full w-full flex items-center justify-center p-8">
                        <div className="bg-white bg-opacity-75 rounded p-12">
                            <h1 className="cursive text-3xl lg-6xl mb-4">{singlePost.title}</h1>
                            <div className="flex justify-center text-black-800">
                ...
                <BlockContent blocks={singlePost.body} projectId="8ppm8qu2" dataset="production" />
                </div>
            </article>
        </main>
    );
